...
public class BeanObjectSetValueUtil  {
	...
	public void executeMethod(Object object, Object argBean, Method method) {
		try {
			...
			throw new RuntimeException("autowire exception " + e.getMessage());
		}
	}
	...
	public <T> T setProperties(T obj, Map<String, Object> properties) {
		...
		try {
			...
			throw new RuntimeException("setter method not found " + e.getMessage());
		} catch (IllegalArgumentException e) {
			throw new RuntimeException("wrong argument " + e.getMessage());
		} catch (Exception e) {
